...
//
// - 代理：监听 0.0.0.0:<port>（默认 13080），把入站 Host/Origin 改写成
 ...
 * 按实例推导而不是全局固定 13080：测试实例（3082）与生产（3080）并行时
 * 各自得到 13082/13080，不再抢同一个端口。dshPort 非法（缺省/越界）退回 13080。
 ...
 * @param {number} [opts.port]    代理端口（未传时由 lib/index.js 以 dshPort+10000 推导）
